...
if( $_SESSION["autoriser"]!="oui"){
  ...
  if (isset($valider)){   
    ...
    if($reponse->rowCount()>0) {
      $sel="UPDATE etudiant SET email='$email' , nom='$nom' ,prenom='$prenom',adresse='$adresse',classe='$classe' where cin='$cin'";
      ...
      <div class="container" method="post">
        <form method="post" name="fo" id="myform"  action="">
          <div class="form-group" action=''>
            ...
            <label for="id">nom de l'etudiant :</label><br />
            <input
              type="text"
              id="nom"
              name="nom"
          ...
          <div class="form-group" action=''>
            <label for="id">prenom de l'etudiant :</label><br />
            <input
              type="text"
              id="nom"
              name="prenom"
